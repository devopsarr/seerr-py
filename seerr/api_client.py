...
from seerr.configuration import Configuration
from seerr.api_response import ApiResponse, T as ApiResponseT
import seerr.models
from seerr import rest
from seerr.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'seerr-py/v0.2.1' # x-release-please-version
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(seerr.models, klass)
