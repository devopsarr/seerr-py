...
class CertificationResponse(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each value in certifications (dict of array)
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "certifications": {
                _k: [Certification.from_dict(_item) for _item in _v] if _v is not None else None
                for _k, _v in obj["certifications"].items()
            }
