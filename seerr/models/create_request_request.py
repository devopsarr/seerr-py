...
class CreateRequestRequest(BaseModel):
    ...
    ignore_quota: Optional[StrictBool] = Field(default=None, description="If true, this request will not count against the user's quota. Requires MANAGE_REQUESTS permission.", alias="ignoreQuota", json_schema_extra={"examples": [False]})
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["mediaType", "mediaId", "tvdbId", "seasons", "is4k", "serverId", "profileId", "rootFolder", "languageProfileId", "userId", "ignoreQuota"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ignoreQuota": obj.get("ignoreQuota")
        })
