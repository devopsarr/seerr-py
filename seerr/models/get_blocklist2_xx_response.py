...
class GetBlocklist2XXResponse(BaseModel):
    """
    GetBlocklist2XXResponse
    """ # noqa: E501
    page_info: Optional[PageInfo] = Field(default=None, alias="pageInfo")
    results: Optional[List[GetBlocklist2XXResponseResultsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [GetBlocklist2XXResponseResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
