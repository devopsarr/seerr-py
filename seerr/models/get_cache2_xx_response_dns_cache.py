...
class GetCache2XXResponseDnsCache(BaseModel):
    """
    GetCache2XXResponseDnsCache
    """ # noqa: E501
    stats: Optional[GetCache2XXResponseDnsCacheStats] = None
    entries: Optional[Dict[str, GetCache2XXResponseDnsCacheEntriesValue]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["stats", "entries"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "stats": GetCache2XXResponseDnsCacheStats.from_dict(obj["stats"]) if obj.get("stats") is not None else None,
            "entries": dict(
                (_k, GetCache2XXResponseDnsCacheEntriesValue.from_dict(_v))
