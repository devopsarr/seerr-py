...
class GetJellyfinSync2XXResponse(BaseModel):
    """
    ...
    current_library: Optional[JellyfinLibrary] = Field(default=None, alias="currentLibrary")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "total": obj.get("total"),
            "currentLibrary": JellyfinLibrary.from_dict(obj["currentLibrary"]) if obj.get("currentLibrary") is not None else None,
