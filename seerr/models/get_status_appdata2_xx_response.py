...
class GetStatusAppdata2XXResponse(BaseModel):
    ...
    app_data_permissions: Optional[StrictBool] = Field(default=None, alias="appDataPermissions", json_schema_extra={"examples": [True]})
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["appData", "appDataPath", "appDataPermissions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "appDataPermissions": obj.get("appDataPermissions")
        })
