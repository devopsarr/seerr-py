...
class MainSettings(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["apiKey", "appLanguage", "applicationTitle", "applicationUrl", "hideAvailable", "partialRequestsEnabled", "localLogin", "mediaServerType", "newPlexLogin", "defaultPermissions", "enableSpecialEpisodes"]
