...
class UserSettingsNotifications(BaseModel):
    ...
    discord_ids: Optional[List[StrictStr]] = Field(default=None, alias="discordIds")
    ...
    telegram_message_thread_id: Optional[StrictStr] = Field(default=None, alias="telegramMessageThreadId")
    telegram_send_silently: Optional[StrictBool] = Field(default=None, alias="telegramSendSilently")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["notificationTypes", "emailEnabled", "pgpKey", "discordEnabled", "discordEnabledTypes", "discordIds", "pushbulletAccessToken", "pushoverApplicationToken", "pushoverUserKey", "pushoverSound", "telegramEnabled", "telegramBotUsername", "telegramChatId", "telegramMessageThreadId", "telegramSendSilently"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if discord_ids (nullable) is None
        # and model_fields_set contains the field
        if self.discord_ids is None and "discord_ids" in self.model_fields_set:
            _dict['discordIds'] = None
        ...
        # set to None if telegram_message_thread_id (nullable) is None
        # and model_fields_set contains the field
        if self.telegram_message_thread_id is None and "telegram_message_thread_id" in self.model_fields_set:
            _dict['telegramMessageThreadId'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "telegramMessageThreadId": obj.get("telegramMessageThreadId"),
